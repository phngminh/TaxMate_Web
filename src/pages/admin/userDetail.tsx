...
export default function UserDetail() {
  ...
  const [activeBusinessMenu, setActiveBusinessMenu] = useState<
    number | null
  >(null);
  ...
  <div>
    <Link
      ...
      className="inline-flex p-2 rounded-md border border-border/50 bg-card hover:bg-background transition-colors"
    >
  ...
  <div />
      ...
      <div className="bg-card border border-border/50 rounded-lg p-6">
        ...
        {user.business_profiles.length === 0 ? (
          <div className="text-center py-12 bg-background/30 rounded-lg border border-border/30">
          ...
          <div className="space-y-3">
            {user.business_profiles.map((business: any) => (
              <div
                key={business.id}
                className="bg-background/50 border border-border/50 rounded-lg p-5 hover:border-border transition-all"
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="p-1.5 rounded-md hover:bg-background border border-transparent hover:border-border/50 transition-all"
                    >
                      <MoreVertical className="w-4 h-4 text-muted-foreground" />
                    </button>

                    {activeBusinessMenu === business.id && (
                      <div className="absolute right-0 top-full mt-1 w-48 bg-white border-gray-600 shadow-lg rounded-lg shadow-xl overflow-hidden z-10">
