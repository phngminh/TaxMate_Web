...
const mockDocuments: LegalDocument[] = [
  {
    ...
    source_file_path:
      "/storage/legal/laws/luat_thue_tncn_2024_38_2024_QH15.pdf",
  ...
  },
  {
    ...
    source_file_path:
      "/storage/legal/circulars/TT_78_2023_TT_BTC.pdf",
    ocr_status: "not_required",
    embedding_status: "completed",
    token_count: 148752,
    embedding_model: "text-embedding-3-large",
  ...
  },
  {
    ...
    source_file_path:
      "/storage/legal/decrees/ND_126_2023_ND_CP_scan.pdf",
    ocr_status: "pending",
  ...
  },
  {
    ...
    source_file_path:
      "/storage/legal/circulars/TT_219_2013_TT_BTC.pdf",
    ocr_status: "not_required",
    embedding_status: "completed",
    token_count: 112360,
  ...
  },
  {
    ...
    source_file_path:
      "/storage/legal/decisions/QD_15_2024_BTC_scan_corrupt.pdf",
    ocr_status: "failed",
  ...
  },
  {
    ...
    source_file_path:
      "/storage/legal/decrees/ND_65_2013_ND_CP.pdf",
    ocr_status: "not_required",
    embedding_status: "completed",
    token_count: 82744,
    embedding_model: "text-embedding-ada-002",
  ...
  },
  {
    ...
    source_file_path:
      "/storage/legal/circulars/TT_78_2021_TT_BTC_hoadon.pdf",
    ocr_status: "not_required",
    embedding_status: "completed",
    token_count: 66528,
    embedding_model: "text-embedding-3-large",
...
function OcrBadge({
  ...
  status: LegalDocument["ocr_status"];
}) {
  const configs = {
    completed: {
      label: "COMPLETED",
...
function DocTypePill({
  type,
}: {
  type: LegalDocument["document_type"];
}) {
  const colors: Record<string, string> = {
    Luật: "bg-[#faf5ff] text-[#5d2ec0]",
    "Thông Tư": "bg-[#eff6ff] text-[#2563eb]",
    "Nghị Định": "bg-[#f0f9ff] text-[#0284c7]",
    "Quyết Định": "bg-[#f0fdfa] text-[#14b8a6]",
  };
  return (
    <span
      className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium ${colors[type] ?? "bg-[#f3f4f6] text-[#6b7280]"}`}
    >
      {type}
    </span>
  );
...
function KeywordTypeBadge({
  type,
}: {
  type: DocumentKeyword["keyword_type"];
}) {
  const configs = {
    entity: {
      label: "Entity",
