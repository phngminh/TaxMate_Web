...
const INITIAL_PRODUCTS: Product[] = [
  ...
  { id: 'SP000002', name: 'Hamburger', category: 'Fast food', mainCategory: 'Ăn uống', unit: 'Cái', price: 35000, status: 'active', description: 'Hamburger thịt bò nướng' },
  { id: 'SP000003', name: 'Coca', category: 'Fast food', mainCategory: 'Ăn uống', unit: 'Lon', price: 20000, status: 'active', description: 'Nước ngọt Coca-Cola' }
]
...
export default function Product() {
  ...
  const filteredProducts = useMemo(() => {
    return products.filter((product) => {
      ...
      const matchesMainCategory = selectedMainCategory === 'all' || product.mainCategory === selectedMainCategory
  ...
  const handleOpenEditModal = (product: Product, e: React.MouseEvent) => {
    ...
    setFormMainCategory(product.mainCategory)
